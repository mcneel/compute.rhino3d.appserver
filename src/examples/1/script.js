...
const definition = 'bool_test2.gh'

// setup input change events
const size_slider = document.getElementById( 'RH_IN:size' )
size_slider.addEventListener( 'mouseup', onSliderChange, false )
size_slider.addEventListener( 'touchend', onSliderChange, false )
const bool_checkbox = document.getElementById( 'RH_IN:bool' )
bool_checkbox.addEventListener("click", onSliderChange, false )
...
async function compute(){
  ...
  data.inputs = {
    'RH_IN:size': size_slider.valueAsNumber,
    'RH_IN:bool': bool_checkbox.checked,
  }
